...
<html>
    <head>
      <title>GENERATE PDF FOR YOUR MARKS</title>
        <style>
        :root {
    ...
    <form method="post" action="newsamp.php">
        <h3><b>Class:</b>
             ...
             <select name="studsec">
              ...
              <h3><b>Examination:</b>
                 <select name="studexam">
                    ...
                    <option value="MODAL-PUBLIC">MODAL-PUBLIC</option>
          ...
          <center>
            <div>
              <input type="submit" id="login_button" name="pdf" value="Generate PDF">
            </div>
          </center>
        </form>
      </center>
