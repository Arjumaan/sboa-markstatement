 ...
 <body align="center" background = "bc5.png">
   <center>
     ...
     <?php
        ...
        $q = "SELECT COUNT(*) AS count FROM marklist2 WHERE EXAMINATION = '$studexam' AND YEAR = '$studyear' AND CLASS = '$studclass' AND SECTION = '$studsec'";
        ...
        $count = $row['count'];
            ...
            {
$insert_query = "INSERT INTO marklist2 (ADNO, ROLLNO, CLASS, SECTION, EXAMINATION, YEAR, ENG, TAM, MAT, SCI, SOC_SCI)";
$insert_query .= "SELECT ADNO, ROLLNO, '$studclass', '$studsec', '$studexam', '$studyear',NULL, NULL, NULL, NULL, NULL FROM student2 ";
$insert_query .= "WHERE CLASS = '$studclass' AND SECTION = '$studsec'";
         ...
         echo "<form method='post' action='marktable1.php'>";
