...
<html lang="en">
  ...
  <body background="bc4.png" width=100% align="center">
     ...
     <p><b> CLick the following links to enter your students mark.</p></b><BR><BR>
       <?php
       ...
       //only inserting data of students and mark is inserted in another form
         require_once 'configure.php';
           $q= "INSERT INTO student2 values('$name','$adno','$class','$sec','$rollno')";
         mysqli_query($con,$q);
         mysqli_close($con);
       ?>

       <div>
         <a href="send.html"> <input type="button" class="registerbtn" value="RE-ENTER DATA FOR STUDENTS"> </a> <br>
       </div>
       <div>
         <a href="cls&sec1.html"> <input type="button" class="registerbtn" value="ENTER MARKS FOR SUBJECT"> </a> <br>
       </div>
       </center>
       <div>
